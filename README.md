...
DANS LE CADRE DE FONCTIONS, LES VARIABLES SONT LOCALISÉES, C'EST A DIRE QUE VOUS NE POURREZ PAS ACCÉDER A DES VALEUR PROVENANT DE L'EXTÉRIEURS, EXCEPTÉS VIA L'UTILISATION DE PARAMÈTRES, QUI EN RÉALITÉ COPIE LA VALEUR EXTÉRIEUR DANS LA CADRE LOCAL LE TEMPS DE L'EXÉCUTION.
...
LE PRÉSENT PROJET EST LIVRÉ AVEC DES EXEMPLES DE PROGRAMMES SIMPLES QUI PERMETTENT D'APPRÉHENDER LE LANGAGE ET SES POSSIBILITÉS. VOICI UNE LISTE DES EXEMPLES ET LES ÉLÉMENTS DU LANGAGE QUI SONT MIS EN AVANT.

## HELLO.TXT
UNE SIMPLE SUITE D'INSTRUCTION, TRÈS RÉPÉTITIVES QUI VONT AFFICHER LE TEXTE `Hello world!` À L'ÉCRAN.

## HELLO_LIST.TXT
DANS LE MÊME GENRE QU'HELLO.TXT, A LA DIFFÉRENCE QUE L'ON UTILISE D'ABORD UNE LISTE POUR STOCKER LES VALEURS DES CARACTÈRES PUIS UNE BOUCLE POUR PARCOURIR CETTE LISTE EN AFFICHANT LE CONTENU.
...
CET EXEMPLE VA GÉNÉRER LES 15 PREMIERS TERMES DE LA SUITE DE FIBONACCI. EN PREMIER LIEU, ON DÉTERMINE QUATRE VARIABLES. TOUTES INITIALISÉES AVEC LA VALEUR 1, LA PREMIÈRE SERVIRA DE POINT DE COMPARAISON POUR LA BOUCLE QUI VA GÉNÉRER LA SÉQUENCE. LES TROIS AUTRES REPRÉSENTENT LES DEUX DERNIERS TERMES DE LA SÉQUENCE DE FIBONACCI AINSI QU'UNE PLACE POUR CONTENIR LE PROCHAIN TERME. QUAND LE NOUVEAU TERME EST GÉNÉRÉ, ON DÉCALE NOS VALEURS DANS NOS VARIABLES POUR RETROUVER LA MÊME STRUCTURE ET PROCÉDER À LA GÉNÉRATION DU TERME SUIVANT.

## FIBONACCI_RECURSIVE.TXT
ICI, ON APPELLE UNE FONCTION RÉCURSIVE AVEC TROIS PARAMÈTRES, LES DEUX PREMIERS TERMES DE LA SUITE DE FIBONACCI, A SAVOIR : 1 ET 1, PUIS LA VALEUR LIMITE À LAQUELLE ON SOUHAITE ARRÊTER LA SÉQUENCE. LA FONCTION, DÉFINIE AU DÉBUT DU FICHIER SE TIENT COMME SUIT. LA FONCTION PREND DEUX PARAMÈTRES ET AFFICHE LE PREMIER, SUIVI D'UN ESPACE. ENSUITE ON VÉRIFIE LA CONDITION D'ARRÊT AVEC UN `SOMEHOW`. SI LA VALEUR DU SECOND TERME (NON AFFICHÉ), EST PLUS GRANDE QUE LA VALEUR LIMITE, ON SE CONTENTE D'AFFICHER LA VALEUR DU PREMIER TERME. SINON, ON CALCULE LE TERME SUIVANT ET L'ON RAPPELLE LA FONCTION RÉCURSIVE AVEC LE DERNIER ET LE NOUVEAU TERME (ET LA LIMITE) POUR CONTINUER LA GÉNÉRATION DE LA SÉQUENCE.

# 5. CONCLUSION
NOUS AVONS OBTENU UN INTERPRÉTEUR, CONFORMÉMENT À NOS ATTENTES. CEPENDANT, LE VOLUME DE TRAVAIL AYANT ÉTÉ CONSÉQUENT, IL SUBSISTE DES CONFLITS AUX YEUX DE L'INTERPRÉTEUR, MAIS LES OUTILS UTILISÉS ONT DES CHOIX PAR DÉFAUT QUI CONVIENNENT À CE QUI ÉTAIT PLANIFIÉ. CES CONFLITS SE SITUENT AU NIVEAU DE LA RÉCURSIVITÉ DANS LES LISTES DE PARAMÈTRES. POUR ÉVITER TOUTE AMBIGUÏTÉ, SI LE PROJET DEVAIT GROSSIR, IL SERAIT BON DE RÉGLER CES CONFLITS TANT QU'ILS EXISTENT EN QUANTITÉ LIMITÉE.

LE TRAVAIL D'AMÉLIORATION QU'IL RESTE À EFFECTUER EN REGARD DU LANGAGE SE SITUERAIT AU NIVEAU LOGIQUE. LE LANGAGE AYANT ÉTÉ INVENTÉ ET CONCU PAR LES MÊMES PERSONNES, IL N'EST PAS GARANTI QUE LA PRISE EN MAIN OU LA LOGIQUE MISE EN PLACE DANS LE FONCTIONNEMENT DU LANGAGE CONVIENNENT À TOUT LE MONDE. MALGRÉ CELA, NOUS AVONS PU METTRE EN OEUVRE TOUT CE QUE NOUS AVONS SOUHAITÉ ET OBTENU LES RÉSULTATS ESPÉRÉS.
